...
Rails.application.config.assets.paths << Rails.root.join('vendor', 'assets', 'bower_components', 'inline-attachment', 'src')

Rails.application.config.assets.precompile += %w(admin.css admin.js *.png *.jpg *.jpeg *.svg)
